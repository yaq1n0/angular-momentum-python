...
from myvars import frame_bottom_pad1, frame_bottom_pad2
from myvars import fb_rely_primary, fb_rely_secondary
...
def run_main(root, frame):
    if dev:
        print 'main elements created'

    # creating frames
    main_pf1 = MyFrame(frame, colors[4])
    main_pf2 = MyFrame(frame, colors[4])
    frame1 = MyFrameWBP(frame, colors[4], frame_bottom_pad1)
    frame2 = MyFrameWBP(frame, colors[4], frame_bottom_pad1)
    frame3 = MyFrameWBP(frame, colors[4], frame_bottom_pad1)
