...
def goto(bf):
    ...
    if myvars.perf and bf != start_bf:
...
# conditionally binding escape
if myvars.perf:
    # binding escape to restart the program to return to start
    root.bind("<Escape>", program_restart_bind)

if not myvars.perf:
    # binding escape to flip frames to return to start
